...
class OnlineShop extends Component {
  ...
  staticSeo = {
    ...
    seo_description: "Разработка мобильного приложения под ключ состоит из 5 основных этапов реализации. Каждый из которых, включает свой список работ, кол-во которых, зависит от необходимых функций и возможностей, логики и сторонних интеграций у предстоящего проекта. Ниже подробно о каждом из них"
  }
