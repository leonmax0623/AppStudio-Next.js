...
class Intelligence extends Component {
  ...
  staticSeo = {
    seo_title: "Разработка проекта с искусственным интеллектом (ИИ) | APPs Studio",
    seo_description: "Эффективное решение задачи с помощью моделей машинного обучения (ML)"
  }
