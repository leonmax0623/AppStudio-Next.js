...
class Portfolio extends Component {
  ...
  staticSeo = {
    ...
    seo_description: "Выполнили более 60 проектов за 9 лет. Маркетплейсы, Онлайн-магазины и проекты с Искусственным Интелектом - наш основной профиль, делаем их реально круто"
  }
